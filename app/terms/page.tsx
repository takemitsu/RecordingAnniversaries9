...
export default async function TermsPage() {
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-4xl py-4 px-4 md:py-8 md:px-8">
        <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-sm">
          <div className="px-4 py-6 md:px-8 md:py-8">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1">
                    ...
                    <li>
                      記念日グループ（Collection）の作成・管理による分類機能
                    </li>
              ...
              <div className="mt-12 p-4 md:p-6 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
